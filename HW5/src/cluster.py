...
class Cluster(object) :
    ...
    def centroid(self) :
        ...
        cluster_label, count = stats.mode(labels)
       # print(meanattr)
        centroid = Point("centroid",cluster_label,meanattr)
        return centroid
        ### ========== TODO : END ========== ###
    ...
    def medoid(self) :
        ...
        for p in self.points:
            ...
            for q in self.points:
                if p!=q:
                    distancesum+=p.distance(q)
            if distancesum< closestdis:
                closestdis=distancesum
                medoid=p
